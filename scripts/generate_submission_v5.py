...
def main():
    ...
    para(doc,
        '[1] C. Lemieux et al., "CodaMOSA: Escaping Coverage Plateaus in Test '
        'Generation with Pre-trained Large Language Models," ICSE 2023.\n'
        '[2] Y. Chen et al., "ChatUniTest: A Framework for LLM-Based Test '
        'Generation," FSE 2024.\n'
        '[3] M. Schafer et al., "An Empirical Evaluation of Using Large Language '
        'Models for Automated Unit Test Generation," IEEE TSE, vol. 50, 2024.\n'
        '[4] J. A. Ramos et al., "CoverUp: Coverage-Guided LLM-Based Test '
        'Generation," arXiv:2403.16218, 2024.\n'
        '[5] N. S. Mathews and M. Nagappan, "Design choices made by LLM-based '
        'test generators prevent them from finding bugs," arXiv:2412.14137, 2024.',
        sz=8.5, after=Pt(0))
